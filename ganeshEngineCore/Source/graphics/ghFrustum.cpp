...
void Frustum::updateInternal() {
	if(mDirty) {
		...
		mPlanes[FrustumPlane::FAR] = new Plane(mFars[PlaneCorner::BOTTOM_RIGHT], mFars[PlaneCorner::TOP_RIGHT], mFars[PlaneCorner::TOP_LEFT]);
		mPlanes[FrustumPlane::LEFT] = new Plane(mNears[PlaneCorner::TOP_LEFT], mFars[PlaneCorner::TOP_LEFT], mFars[PlaneCorner::BOTTOM_LEFT]);
		mPlanes[FrustumPlane::RIGHT] = new Plane(mFars[PlaneCorner::BOTTOM_RIGHT], mNears[PlaneCorner::BOTTOM_RIGHT], mNears[PlaneCorner::TOP_RIGHT]);
