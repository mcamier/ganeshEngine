                           ...
                           PipelineInfos *pipelineInfos)
{
    ...
    REP_DEBUG("    vertex shader module created", LOG_CHANNEL::RENDER);

    createShaderModule(device,
                       readFile(fragShaderFilename),
                       &pipelineInfos->fragmentShaderModule);
    REP_DEBUG("    fragment shader module created", LOG_CHANNEL::RENDER);
    ...
    REP_DEBUG("    pipelineLayout created", LOG_CHANNEL::RENDER);
    ...
    REP_DEBUG("    pipeline created", LOG_CHANNEL::RENDER);
}
